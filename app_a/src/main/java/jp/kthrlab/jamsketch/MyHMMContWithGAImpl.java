...
import jp.crestmuse.cmx.inference.models.HMMContImpl;

//import be.ac.ulg.montefiore.run.jahmm.ObservationReal;

public class MyHMMContWithGAImpl extends HMMContImpl {
  ...
  public MyHMMContWithGAImpl(GACalculator<Integer, Double> gacalc,
  ...
  MyHMMContWithGAImpl(double[] pi, double[][] a,
                      List<? extends RealDistribution> b,
                      GACalculator<Integer,Double> gacalc,
                      int initialNum, int popLimit, double elitRate,
                      CrossoverPolicy crossoverPolicy, double crossoverRate,
                      MutationPolicy mutationPolicy, double mutationRate,
                      SelectionPolicy selectionPolicy) {
