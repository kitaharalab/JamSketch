 ...
 * @author K.Shoji
 */
public abstract class AbstractMultipleMidiAppCompatActivity extends AppCompatActivity implements OnMidiDeviceDetachedListener, OnMidiDeviceAttachedListener, OnMidiInputEventListener {
	...
	final class OnMidiDeviceAttachedListenerImpl implements OnMidiDeviceAttachedListener {
        ...
        public void onMidiInputDeviceAttached(@NonNull final MidiInputDevice midiInputDevice) {
            midiInputDevice.setMidiEventListener(AbstractMultipleMidiAppCompatActivity.this);
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    AbstractMultipleMidiAppCompatActivity.this.onMidiInputDeviceAttached(midiInputDevice);
                }
            });
        }
        ...
        public void onMidiOutputDeviceAttached(@NonNull final MidiOutputDevice midiOutputDevice) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    AbstractMultipleMidiAppCompatActivity.this.onMidiOutputDeviceAttached(midiOutputDevice);
                }
            });
        }
    }
	...
	final class OnMidiDeviceDetachedListenerImpl implements OnMidiDeviceDetachedListener {
        ...
        public void onMidiInputDeviceDetached(@NonNull final MidiInputDevice midiInputDevice) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    AbstractMultipleMidiAppCompatActivity.this.onMidiInputDeviceDetached(midiInputDevice);
                }
            });
        }
        ...
        public void onMidiOutputDeviceDetached(@NonNull final MidiOutputDevice midiOutputDevice) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    AbstractMultipleMidiAppCompatActivity.this.onMidiOutputDeviceDetached(midiOutputDevice);
                }
            });
        }
    }
